...
class AiPredictionRepository implements AiPredictionRepositoryInterface {
    protected $model;
    public function __construct(\App\Models\AiPrediction $model = null) { $class = '\App\Models\AiPrediction'; $this->model = $model ?? new $class; }
