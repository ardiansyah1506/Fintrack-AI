...
class AiWarningRepository implements AiWarningRepositoryInterface {
    protected $model;
    public function __construct(\App\Models\AiWarning $model = null) { $class = '\App\Models\AiWarning'; $this->model = $model ?? new $class; }
