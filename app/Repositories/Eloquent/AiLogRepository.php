...
class AiLogRepository implements AiLogRepositoryInterface {
    protected $model;
    public function __construct(\App\Models\AiLog $model = null) { $class = '\App\Models\AiLog'; $this->model = $model ?? new $class; }
