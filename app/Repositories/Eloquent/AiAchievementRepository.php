...
class AiAchievementRepository implements AiAchievementRepositoryInterface {
    protected $model;
    public function __construct(\App\Models\AiAchievement $model = null) { $class = '\App\Models\AiAchievement'; $this->model = $model ?? new $class; }
