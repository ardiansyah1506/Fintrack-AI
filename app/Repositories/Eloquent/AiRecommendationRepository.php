...
class AiRecommendationRepository implements AiRecommendationRepositoryInterface {
    protected $model;
    public function __construct(\App\Models\AiRecommendation $model = null) { $class = '\App\Models\AiRecommendation'; $this->model = $model ?? new $class; }
